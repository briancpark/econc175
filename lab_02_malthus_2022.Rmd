...
call these crude 
rates. ("Crude" because we don't refine the
...
> 1.  Turn in your plot of the relationship between birth and death rates from 1801-1850. (Note: to save a graph from your RStudio notebook, right click on it with your mouse and "Save image as ...")
...
malthus.plot.fun(from.year = 1801, to.year = 1850)
```
> 2.  In which of the periods you explored above does the Malthusian relationship first break down? What is your basis for judging? What happens to the *time trends* in birth and death rates that makes the Malthusian relationship go away?

1851 to 1900. This is purely based on observing the correlation coefficient. In 1801-1850, the correlation is -0.21, following Mathusian theory. But as years progress, such as 1851-1900, that coeffcient is 0.55, which is positive. That means as time passes, the birth rate is decreasing while death rate is increasing.
...
Mathus states that the main determinant of birth rates in Norwary is the rate of marriage. Because of the restriction imposed on marriage, such as proof of ability to support a family, birth rate is tightly correlated with the marriage rate. 
...
Birth rate increase, death rate decrease, and wages increase.
> 5.  According to Malthus, in the long term, should the population of Ireland return to its initial size? Why or why not?

No, the population of Ireland will actually grow to a new asymptotic maximum. The shift of economy with new wage allows Ireland to grow in population, while supporting the same wage when the population has reached its maximum. 
> Questions 6 to 8: pen-and-paper questions

> 6.  On a separate sheet of paper, draw your own Malthusian graph system. (We recommend drawing by hand.) The top graph should show birth and death rates as a function of wages; the bottom graph should show population size as a function of wages. Label all of the axes and mark the equilibrium state on both graphs by marking b*, d*, w*, and N* (equilibrium birth rate, death rate, wage rate, and population size) on the appropriate axes.

![](malthus.jpg)

> 7.  Imagine that marriage norms change and people start getting married at later ages and that this results in a lower birth rate at every wage level. Show this change on your graph by drawing a second, dotted, birth rate line. Mark the new equilibria as b', d', w', and P'. Describe in words what happened to the equilibrium wage level and population size.
...
Temporary move upward (to the left) for wage in the population vs wage curve. Then with decreased wages, the birth rate would also drop with increase of death rates, shifting the equilibrium to the left. 
> 9.  Review questions on optimum population: from last week:
>
> ```{=html}
> <!-- -->
> ```
> a.  What would happen to optimum population size from the point of view of Sauvy's economic optimum if overhead (e.g., tribute paid to outsiders) were increased?
> b.  True or false, explain in one sentence. The amount of overhead has no impact on Sauvy's power optimum.
...
# Notes on possible extensions of this lab (new for 2021)

If you want to do a mini-project later in the semester, here are some
possibilities for extending this analysis. You don't have to do any of
this, although you might want to read through both to get additional
ideas and to put what we've done in context. 
